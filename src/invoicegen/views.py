...
from .form import InvoiceForm , InvoiceSearchForm, InvoiceUpdateForm
from .models import *
...
def list_invoice(request):
	...
	if request.method == 'POST':
		...
		if form['generate_invoice'].value() == True:
			...
			def generate_invoice(name, invoice_number, address,
				...
				# else:
				c.drawCentredString(400, 660, str("INVOICE No.") + ':')
				c.setFont('Helvetica', 12, leading=None)
				...
				c.setFont('Helvetica', 12, leading=None)
				c.drawCentredString(200, 640, phone_number)   

				c.setFont('Helvetica', 12, leading=None)
				c.drawCentredString(98, 620, "Address:")
				c.setFont('Helvetica', 12, leading=None)
				c.drawCentredString(250, 620, address)    
				...
				c.drawCentredString(325, 140, "TOTAL:")
				c.setFont('Helvetica-Bold', 20, leading=None)
